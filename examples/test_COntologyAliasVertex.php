...
/**
 * {@link COntologyAliasVertex.php Base} object test suite.
 *
 * This file contains routines to test and demonstrate the behaviour of the
 * base object {@link COntologyAliasVertex class}.
 *
 *	@package	Test
...
//
class MyClass extends COntologyAliasVertex
{
	//
...
//	$server->Graph( new CNeo4jGraph() );
	...
	$database->Drop();
	echo( '$container = COntologyAliasVertex::DefaultContainer( $database );<br />' );
	$container = COntologyAliasVertex::DefaultContainer( $database );
	echo( '<hr />' );
	echo( '<hr />' );
