...
/**
 * {@link COntologyMasterVertex.php Base} object test suite.
 *
 * This file contains routines to test and demonstrate the behaviour of the
 * base object {@link COntologyMasterVertex class}.
 *
 *	@package	Test
...
//
class MyClass extends COntologyMasterVertex
{
	//
...
//	$server->Graph( new CNeo4jGraph() );
	...
	$database->Drop();
	echo( '$container = COntologyMasterVertex::DefaultContainer( $database );<br />' );
	$container = COntologyMasterVertex::DefaultContainer( $database );
	echo( '<hr />' );
	echo( '<hr />' );
...
//	$status = $termE->Insert( $database );
	...
	echo( 'Node<pre>' ); print_r( $nodeA ); echo( '</pre>' );
	echo( 'Graph<pre>' ); print_r( $nodeA->GetGraphNodeProperties( $database ) ); echo( '</pre>' );
	echo( '<hr />' );
	...
	$edge = $nodeB->RelateTo( $predicate, $nodeA, $database );
	echo( 'Node<pre>' ); print_r( $nodeB ); echo( '</pre>' );
	echo( 'Graph<pre>' ); print_r( $nodeB->GetGraphNodeProperties( $database ) ); echo( '</pre>' );
	echo( $edge->GID() );
	echo( '<hr />' );
	...
	$edge = $nodeD->RelateTo( $predicate, $nodeB, $database );
	echo( 'Node<pre>' ); print_r( $nodeD ); echo( '</pre>' );
	echo( 'Graph<pre>' ); print_r( $nodeD->GetGraphNodeProperties( $database ) ); echo( '</pre>' );
	echo( $edge->GID() );
	echo( '<hr />' );
	...
	$edge = $nodeE->RelateTo( $predicate, $nodeD, $database );
	echo( 'Node<pre>' ); print_r( $nodeE ); echo( '</pre>' );
	echo( 'Graph<pre>' ); print_r( $nodeE->GetGraphNodeProperties( $database ) ); echo( '</pre>' );
	echo( $edge->GID() );
	echo( '<hr />' );
	echo( '<hr />' );
	...
	$edge = $nodeC->RelateTo( $predicate, $nodeA, $database );
	echo( 'Node<pre>' ); print_r( $nodeC ); echo( '</pre>' );
	echo( 'Graph<pre>' ); print_r( $nodeC->GetGraphNodeProperties( $database ) ); echo( '</pre>' );
	echo( $edge->GID() );
	echo( '<hr />' );
	...
	$edge = $nodeD->RelateTo( $predicate, $nodeC, $database );
	echo( 'Node<pre>' ); print_r( $nodeD ); echo( '</pre>' );
	echo( 'Graph<pre>' ); print_r( $nodeD->GetGraphNodeProperties( $database ) ); echo( '</pre>' );
	echo( $edge->GID() );
	echo( '<hr />' );
