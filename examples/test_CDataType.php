...
// Class includes.
//
require_once( kPATH_MYWRAPPER_LIBRARY_CLASS."/CDataTypeInt32.php" );
require_once( kPATH_MYWRAPPER_LIBRARY_CLASS."/CDataTypeInt64.php" );
require_once( kPATH_MYWRAPPER_LIBRARY_CLASS."/CDataTypeStamp.php" );
require_once( kPATH_MYWRAPPER_LIBRARY_CLASS."/CDataTypeBinary.php" );
require_once( kPATH_MYWRAPPER_LIBRARY_CLASS."/CDataTypeMongoId.php" );
...
try
{
	...
	$array = array
	(
		kTAG_LID => new MongoId( '4d95830b2e4398070722f414' ),
		'Stamp' => new MongoDate(),
