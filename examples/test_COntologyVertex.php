...
/**
 * {@link COntologyVertex.php Base} object test suite.
 *
 * This file contains routines to test and demonstrate the behaviour of the
 * base object {@link COntologyVertex class}.
 *
 *	@package	Test
...
//
class MyClass extends COntologyVertex
{
	//
...
try
{
	...
	$database->Drop();
	echo( '$container = COntologyVertex::DefaultContainer( $database );<br />' );
	$container = COntologyVertex::DefaultContainer( $database );
	echo( '<hr />' );
	echo( '<hr />' );
