...
try
{
	...
	//
	echo( '<i>$test = new CQueryStatement( "SUBJECT", kOPERATOR_EQUAL, kTYPE_STAMP, new MongoDate() );</i><br>' );
	$test = new CQueryStatement( "SUBJECT", kOPERATOR_EQUAL, kTYPE_STAMP, new MongoDate() );
	echo( '<pre>' ); print_r( $test ); echo( '</pre>' );
