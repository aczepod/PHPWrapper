 ...
 *		{@link kOFFSET_PATH}, it will append the provided item to the end of the list.
	...
	public function PushItem( $theValue )
	{
		...
		if( $theValue !== NULL )
		{
			...
			if( $this->offsetExists( kOFFSET_PATH ) )
			{
				...
				// Get list.
				//
				$list = $this->offsetGet( kOFFSET_PATH );
				...
				// Update list.
				//
				$this->offsetSet( kOFFSET_PATH, $list );
			...
			// Create list.
			//
			$this->offsetSet( kOFFSET_PATH, array( $theValue ) );
 ...
 *======================================================================================*/
	...
	{
		return implode( kTOKEN_INDEX_SEPARATOR, $this->offsetGet( kOFFSET_PATH ) );	// ==>
 ...
 *======================================================================================*/
	 ...
	 *
	 * In this class we ensure that the {@link kOFFSET_PATH} offset is an array, ArrayObject
 ...
 *======================================================================================*/
	...
	protected function _PrecommitValidate( &$theConnection, &$theModifiers )
	{
		...
		//
		if( ! (count( $this->offsetGet( kOFFSET_PATH ) ) % 2) )	// Even.
			throw new Exception
 ...
 *======================================================================================*/
	...
	protected function _Ready()
	{
		...
		//
		if( parent::_Ready() )
			return $this->offsetExists( kOFFSET_PATH );								// ==>
