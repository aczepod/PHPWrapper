 ...
 *		<tt>{@link kTAG_VERTEX_SUBJECT}</tt> tag, represents the start or origin of a
 *		relationship, it is constituted by the reference to a {@link CNode} instance, using
 *		the node's {@link kOFFSET_NID}.  This attribute is required.
 ...
 *		instance, using the term's {@link kOFFSET_NID}.  This attribute is required.
 *	<li><i>Object vertex</i>: The object vertex, <tt>{@link Object()}</tt> or the
 *		<tt>{@link kTAG_VERTEX_OBJECT}</tt> tag, represents the end or destination of a
 *		relationship, it is constituted by the reference to a {@link CNode} instance, using
 *		the node's {@link kOFFSET_NID}.  This attribute is required.
