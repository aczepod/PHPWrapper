 ...
 *======================================================================================*/
	...
	protected function _InitDefaultAttributeTerms()
	{
		...
		$terms = array(
			...
			array( kOFFSET_LID => substr( kOFFSET_REFS_TAG_FEATURE, 1 ),
				   kOFFSET_NAMESPACE => $ns,
				   kOFFSET_LABEL => "Feature tag references",
				   kOFFSET_DESCRIPTION => "This offset identifies tag references, the attribute contains the list of tag identifiers that reference the hosting object as a feature." ),
			array( kOFFSET_LID => substr( kOFFSET_REFS_TAG_SCALE, 1 ),
				   kOFFSET_NAMESPACE => $ns,
				   kOFFSET_LABEL => "Scale tag references",
				   kOFFSET_DESCRIPTION => "This offset identifies tag references, the attribute contains the list of tag identifiers that reference the hosting object as a scale." ),
	...
	protected function _LoadNodeDataDictionary()
	{
		...
		$terms = array(
			...
			array( kOFFSET_LID => substr( kOFFSET_TYPE, 1 ),
				   ...
				   kOFFSET_TYPE => kTYPE_ENUM_SET ),
			array( kOFFSET_LID => substr( kOFFSET_REFS_TAG_FEATURE, 1 ),
				   kOFFSET_GID => kOFFSET_REFS_TAG_FEATURE,
				   kOFFSET_NAMESPACE => $ns,
				   kOFFSET_TYPE => array( kTYPE_INT64, kTYPE_CARD_ARRAY ) ),
			array( kOFFSET_LID => substr( kOFFSET_REFS_TAG_SCALE, 1 ),
				   kOFFSET_GID => kOFFSET_REFS_TAG_SCALE,
				   kOFFSET_NAMESPACE => $ns,
				   kOFFSET_TYPE => array( kTYPE_INT64, kTYPE_CARD_ARRAY ) ),
			array( kOFFSET_LID => substr( kOFFSET_REFS_EDGE, 1 ),
