...
/**
 * <h4>64 bit signed integer</h4>
 *
 * This class represents a 64 bit signed integer, the object is structured as follows:
 *
 * <ul>
 *	<li><i>{@link kTAG_CUSTOM_TYPE }</i>: The constant {@link kTYPE_INT64}.
 *	<li><i>{@link kTAG_CUSTOM_DATA}</i>: A string representing the integer.
 * </ul>
 *
 * This class may be necessary if PHP doesn't handle 64 bit integers.
 *
 *	@package	MyWrapper
 *	@subpackage	Framework
 */
 ...
 *======================================================================================*/
	 ...
	 * Instantiate class.
	 *
	 * In this class we store {@link kTYPE_INT64} in the {@link kTAG_CUSTOM_TYPE} offset and
	 * the integer in the {@link kTAG_CUSTOM_DATA} offset.
	 *
	 ...
	 *
	 * The number will be stored in the {@link kTAG_CUSTOM_DATA} offset as an integer, if
	...
	public function __construct( $theData = NULL )
	{
		...
		{
			$this->offsetSet( kTAG_CUSTOM_TYPE, kTYPE_INT64 );
			$this->offsetSet( kTAG_CUSTOM_DATA, ( PHP_INT_SIZE < 8 ) ? $data
																	 : (integer) $data );
 ...
 *======================================================================================*/
	 ...
	 * the {@link CDataType::value()} method.
	 *
	 * @access public
	 * @return mixed
	 *
	...
	public function value()
	{
		...
		//
		if( PHP_INT_SIZE >= 8 )
			return (integer) $this->offsetGet( kTAG_CUSTOM_DATA );							// ==>
