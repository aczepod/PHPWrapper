 ...
 *
 * <ul>
 *	<li><i>{@link kTAG_CUSTOM_TYPE}</i>: The constant {@link kTYPE_INT32}.
 *	<li><i>{@link kTAG_CUSTOM_DATA}</i>: An integer representing the integer :-)
 * </ul>
 *
 *	@package	MyWrapper
 *	@subpackage	Framework
 ...
 *======================================================================================*/
	 ...
	 * Instantiate class.
	 *
	 * In this class we store {@link kTYPE_INT32} in the {@link kTAG_CUSTOM_TYPE} offset and
	...
	public function __construct( $theData = NULL )
	{
		...
		{
			$this->offsetSet( kTAG_CUSTOM_TYPE, kTYPE_INT32 );
			$this->offsetSet( kTAG_CUSTOM_DATA, (integer) $data );
 ...
 *======================================================================================*/
	 ...
	 * @throws Exception
	 */
	public function value()		{	return (integer) $this->offsetGet( kTAG_CUSTOM_DATA );	}
