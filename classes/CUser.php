 ...
 *======================================================================================*/
	 ...
	 *
	 * The <i>role</i>, {@link kTAG_USER_ROLE}, holds the role of the user according to the
	 * hosting system. It is a string that identifies the user role specific to the hosting
	 ...
	 * @see kTAG_USER_ROLE
	 */
	public function Role( $theValue = NULL, $getOld = FALSE )
	{
		return ManageOffset( $this, kTAG_USER_ROLE, $theValue, $getOld );			// ==>
