 ...
 *		is constituted by the {@link kOFFSET_NID} of the referenced term and is optional.
 *	<li><i>Namespace references</i>: The namespace references,
 *		<tt>{@link NamespaceRefs()}</tt> or the <tt>{@link kTAG_REFS_NAMESPACE}</tt> tag,
 ...
 *		<tt>{@link kTAG_REFS_NODE}</tt> tag, represents the list of references to the nodes
 *		that reference the current term. It is an array of {@link COntologyNode}
 *		{@link kOFFSET_NID} attributes of nodes that reference the current term through
 ...
 *		<tt>{@link FeatureTagRefs()}</tt> or the <tt>{@link kTAG_REFS_TAG_FEATURE}</tt> tag,
 *		represents the list of references to {@link COntologyTag} instances that reference
 *		the current term as a {@link kKIND_NODE_TRAIT} feature. It is an array of
 *		{@link COntologyTag} {@link kOFFSET_NID} attributes of tags in which the the first
 ...
 *		<tt>{@link MethodTagRefs()}</tt> or the <tt>{@link kTAG_REFS_TAG_METHOD}</tt> tag,
 *		represents the list of references to {@link COntologyTag} instances that reference
 *		the current term as a {@link kKIND_NODE_METHOD} method. It is an array of
 *		{@link COntologyTag} {@link kOFFSET_NID} attributes of tags in which the the middle
 ...
 *		<tt>{@link ScaleTagRefs()}</tt> or the <tt>{@link kTAG_REFS_TAG_SCALE}</tt> tag,
 *		represents the list of references to {@link COntologyTag} instances that reference
 *		the current term as a {@link kKIND_NODE_SCALE} feature. It is an array of
 *		{@link COntologyTag} {@link kOFFSET_NID} attributes of tags in which the the last
 *		vertex node in their path, {@link kTAG_PATH}, attribute refers to the current term.
 ...
 *======================================================================================*/
	 ...
	 *
	 * The <i>method tag references</i>, {@link kTAG_REFS_TAG_METHOD}, holds a list of
	 * identifiers of tags that reference the current object as a feature.
	 *
	 * The method is read-only, because this value must be managed externally.
	 *
 ...
 *======================================================================================*/
	 ...
	 * {@link kTAG_REFS_NAMESPACE}, {@link kTAG_REFS_NODE}, {@link kTAG_REFS_TAG_FEATURE},
	 * {@link kTAG_REFS_TAG_METHOD} and {@link kTAG_REFS_TAG_SCALE} offsets in all cases,
	 ...
	 * @see kTAG_REFS_NAMESPACE kTAG_REFS_NODE
	...
	protected function _Preset( &$theOffset, &$theValue )
	{
		...
		//
		$offsets = array( kTAG_REFS_NAMESPACE, kTAG_REFS_NODE, kTAG_REFS_TAG_FEATURE,
						  kTAG_REFS_TAG_METHOD, kTAG_REFS_TAG_SCALE );
