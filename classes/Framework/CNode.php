 ...
 * a {@link CTerm} object, which defines the abstract concept that the node represents.
 *
 ...
 *======================================================================================*/
	 ...
	 *
	 * The method accepts a parameter which represents either the type reference, or the
	 * requested operation, depending on its value:
	 *
	 * <ul>
	 *	<li><tt>NULL</tt>: Return the current value.
